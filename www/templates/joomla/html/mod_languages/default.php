	...
	<div class="btn-group">
		<?php foreach ($list as $language) : ?>
			<?php if ($language->active) : ?>
				<a href="#" data-toggle="dropdown" class="btn dropdown-toggle" dir="<?php echo $language->rtl ? 'rtl' : 'ltr'; ?>"><span class="caret"></span><?php echo $language->title_native; ?></a>
			<?php endif; ?>
		<?php endforeach;?>
		...
		<?php foreach ($list as $language) : ?>
			<?php if ($params->get('show_active', 0) || !$language->active) : ?>
				<li dir="<?php echo $language->rtl ? 'rtl' : 'ltr'; ?>"<?php echo $language->active ? ' class="lang-active"' : ''; ?>>
