...
<div class="span6">
	<a id="latest" class="btn btn-success" title="<?php echo JText::_('HP_BANNER_DOWNLOAD'); ?>" href="<?php echo JHtml::_('content.prepare', '{arslatest item_link \'Joomla*Stable-Full_Package.zip\' Joomla! 6}'); ?>">
		<span class="title">
			...
			<?php echo JText::_('HP_BANNER_DOWNLOAD') . ' ' . JHtml::_('content.prepare', '{arslatest release Joomla! 6}'); ?>
		</span>
		<br />
		English (UK), 
		<?php echo JHtml::_('content.prepare', '{arslatest release Joomla! 6}') . ' ' . JText::_('HP_BANNER_PACKAGE'); ?>, ZIP
	</a>
	<p>
	<?php echo JText::_('HP_BANNER_DESCPART1') . ' ' . JHtml::_('content.prepare', '{arslatest release Joomla! 6}') . ' ' . JText::_('HP_BANNER_DESCPART2'); ?>
	...
	<a title="<?php echo JText::_('HP_BANNER_LINKTITLE2'); ?>" href="<?php echo JHtml::_('content.prepare', '{arslatest release_announcements Joomla! 6}'); ?>" target="_blank">
